    ...
    <div className="Projects" id='Projects'>
      ...
      <div className='ProjectDetils'>
        ...
        <h3>Project Name : My First React App</h3>
          <iframe className='ProjectIframe' src="https://hmjahid-my-first-react-app.netlify.app/" height="300" width="320" title="My First React App"></iframe> 
        ...
        <div className='Project'>
          ...
          <iframe className='ProjectIframe' src="https://jahids-to-do-app.netlify.app/" height="300" width="320" title="To Do App"></iframe> 
        ...
        <div className='Project'>
          ...
          <iframe className='ProjectIframe' src="https://farmerskingdom.netlify.app/" height="300" width="320" title="Farmers Kingdom Web Application"></iframe> 
        ...
        <div className='Project'>
          ...
          <iframe className='ProjectIframe' src="https://softtech1.netlify.app/" height="300" width="320" title="SoftTech - Software Development Company Website Clone"></iframe> 
        ...
        <div className='Project'>
          ...
          <iframe className='ProjectIframe' src="https://outfits1.netlify.app/" height="300" width="320" title="OutFits - An E-commerce Web Application"></iframe> 
