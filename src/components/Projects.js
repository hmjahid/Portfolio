          ...
          <h2 style={{color: "white", fontSize: "32px"}}><u>My Works</u> :</h2>
            ...
            <div className='ProjectDetils'>
              ...
              <h3>Project Name : My First React App</h3>
                ...
                <a href='https://hmjahid-my-first-react-app.netlify.app/' target='_blank'><button className='UniqueButton'>Live Site </button></a>
              </div>
              ...
              <div className='Project'>
                ...
                <a href='https://jahids-to-do-app.netlify.app/' target='_blank'><button className='UniqueButton'>Live Site </button></a>
              </div>
              ...
              <div className='Project'>
                ...
                <a href='https://farmerskingdom.netlify.app/' target='_blank'><button className='UniqueButton'>Live Site </button></a>
              </div>
              ...
              <div className='Project'>
                ...
                <a href='https://softtech1.netlify.app/' target='_blank'><button className='UniqueButton'>Live Site </button></a>
              </div>
              ...
              <div className='Project'>
                ...
                <a href='https://outfits1.netlify.app/' target='_blank'><button className='UniqueButton'>Live Site </button></a>
              </div>
          </div>
        </section>
          ...
          <h2 style={{color: "white", fontSize: "32px"}}><u>Wordpress Projects</u>:</h2>
            <div className='ProjectDetails'>
              <div className='Project'>
                ...
                <iframe className='ProjectIframe' src="https://alphawebservices.netlify.app/" height="320" width="320" title="Alpha Web Services - Web services company website" loading='lazy'></iframe> 
                ...
                <a href='https://alphawebservices.netlify.app/' target='_blank'><button className='UniqueButton'>Live Site </button></a>
              </div>
              ...
              <div className='Project'>
                ...
                <h4>Used Technology : Wordpress, Elementor Page Builder, Astra Theme, Envato Elements, Jetpack</h4>
                <a href='#' target='_blank'><button>Source Code</button></a>
                <a href='https://alphawebservices.wpdevcloud.com/' target='_blank'><button className='UniqueButton'>Live Site </button></a>
              </div>
